...
insert into schedule.groups (group_name) values ('TT-12');
insert into schedule.groups (group_name) values ('YT-16');
insert into schedule.groups (group_name) values ('LG-55');
insert into schedule.groups (group_name) values ('GQ-22');
insert into schedule.groups (group_name) values ('TH-13');
insert into schedule.groups (group_name) values ('GN-33');
insert into schedule.groups (group_name) values ('IT-18');
...
insert into schedule.courses (course_name, course_description) values ('chemistry', 'course of Chemistry');
insert into schedule.courses (course_name, course_description) values ('physics', 'course of Physics');
insert into schedule.courses (course_name, course_description) values ('philosophy', 'course of Philosophy');
insert into schedule.courses (course_name, course_description) values ('drawing', 'course of Drawing');
insert into schedule.courses (course_name, course_description) values ('literature', 'course of Literature');
insert into schedule.courses (course_name, course_description) values ('English', 'course of English');
insert into schedule.courses (course_name, course_description) values ('geography', 'course of Geography');
insert into schedule.courses (course_name, course_description) values ('physical training', 'course of Physical training');
